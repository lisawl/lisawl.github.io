...
function generateMonster() {
    let random = getRNGNumber(3) + 1; //NEU
    if (random == 1) {
        console.log.length("Ich bin ein neues Monster");
        {
            {
                console.log("Es sind +", random, "+neue Monster entstanden););
            }
                ...
                ;
            {
                ...
                console.log(newMonster.monsterExperience); //FEHLER GEFUNDEN(-1 falsch) Man kann nur auf Array-Teile zugreifen, welche definiert sind. -1 ist nicht definitiert (und wird es auch nie sein).
            ...
            function monsterGenerateHTML() {
                ...
                let Flauschigkeitsanzeige = document.createElement("p"); // Erstelle p Element
